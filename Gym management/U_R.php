        ...
        <div class="">
            <div class="centered">
                ...
                <form action="U_R.php" method="post">
                    ...
                    <input class="pad" type="text" name="plan" id="plan" placeholder="Enter the email"> <br><br>
                    ...
                    <input class="pad" type="number" name="uid" id="Uid" placeholder="Enter the email"> <br><br>
